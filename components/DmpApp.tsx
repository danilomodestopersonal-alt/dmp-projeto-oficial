    ...
    return (
      <main className="dashboard-shell">
        ...
        <div className="dashboard-main">
          {view === "today" ? <>
            <header className="dashboard-topbar"><div className="today-heading"><div><p className="dashboard-eyebrow">Sua central do dia</p><h1>Hoje</h1><p>{formatLongDate(todayKey)}</p></div><div className="today-tools"><WeatherWidget onOpen={()=>setView("weather")}/><DigitalClock/></div></div><button className="kids-hero-shortcut" onClick={()=>setView("kids")}><img src="/logo-ctds.png" alt="CT DS Tennis"/><span><small>Gestão das aulas</small><strong>Tênis Kids</strong></span><b>›</b></button></header>
