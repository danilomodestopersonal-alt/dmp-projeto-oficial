...
function AssessmentForm({onClose,onSave}:{onClose:()=>void;onSave:(assessment:Assessment)=>void}) {
  const [values,setValues]=useState<any>({date:today(),weight:"",height:"",bodyFatPercent:"",fatMass:"",leanMass:"",leanMassPercent:"",bmi:"",waterPercent:"",muscleMass:"",basalMetabolicRate:"",phaseAngle:"",visceralFat:"",bodyCellMass:"",hydrationIndex:"",notes:"",measurements:{},photos:[]});
