      ...
      <section className={`dashboard-content ${styles.content}`}>
        ...
        {tab === "ds" ? (
          <div className="finance-ds-single">
            ...
            <section className="panel">
              <div className="panel-head"><div><h2>Alunos Kids</h2><p className="muted">{summary.kids.length} registros · {money.format(summary.kidsGross)} bruto.</p></div><button className="primary" disabled={!editable} onClick={() => openAction({ type: "kid-create" })}>+ Incluir aluno</button></div>
